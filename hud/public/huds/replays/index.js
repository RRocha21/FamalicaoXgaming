...
//aquiv1
    ...
    if (statistics.health == 0) {
        ...
        $player.find(".background").css("width", "190px").css("transition", "all 0.5s ease 0s");
        $player.find(".top_bar").css("width", "190px").css("transition", "all 0.5s ease 0s");
        ...
        $player.find(".background").css("width", "250px").css("transition", "all 0.5s ease 0s");
        $player.find(".top_bar").css("width", "250px").css("transition", "all 0.5s ease 0s");
